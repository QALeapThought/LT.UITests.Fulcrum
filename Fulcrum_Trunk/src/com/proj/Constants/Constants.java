...
// Webtable 	
	// Webtable container property
	public static final String container_property_summary="summary";
	public static final String container_property_id="id";
	
	public static final String Webtable_actionColumnType_Link="Link";
	public static final String Webtable_actionColumnType_Text="Text";
	public static final String Webtable_actionColumnType_DESCENDANT_LINK_1="DESCENDANT_LINK_1";
	
	
	
	//Page title
	public static final String pageTitle_IE=" - Internet Explorer";
	public static final String pageTitle_MyInbox="Mail - My Inbox";
	public static final String dialogTitle_Downloads="View Downloads";
