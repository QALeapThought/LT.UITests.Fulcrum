	...
	final public static String testSiteName = CONFIG.getProperty("testSiteName");
	   ...
	   //#R for Regression,p for Partial Regression,S for sanity
		...
		//# User Credentials  
			...
			final public static String LandingSite = CONFIG.getProperty("LandingSite");
			final public static String LandingPage_main = CONFIG.getProperty("MainsiteLandingPage");
			final public static String LandingPage_subsite = CONFIG.getProperty("subsitesiteLandingPage");
			final public static String environment = CONFIG.getProperty("Environment");
			final public static String fulcrumflavour = CONFIG.getProperty("fulcrumflavour");
