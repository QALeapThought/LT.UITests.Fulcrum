...
public class ToolbarsUtil extends TestBase{
	...
	static {		
		...
		public static void clickList(WebDriver driver,String workFlow) throws Throwable{
			commonMethods.switchToDefaultPage(driver);
			ExplicitWaitUtil.waitForElementTobeActionable(driver, objects_locatorType_Toolbar.get("Toolbar - List"), objects_objectLocator_Toolbar.get("Toolbar - List"), Constants_TimeOuts.Element_TimeOut);
			KeyMethods.f_performAction(driver, refID, testcaseName, workFlow, "Toolbar - List", objects_locatorType_Toolbar, objects_objectType_Toolbar, objects_objectLocator_Toolbar, input);
		}
	...
	public static class List {
		public static void clickPrint(WebDriver driver,String workFlow) throws Throwable{
			commonMethods.switchToDefaultPage(driver);
			ExplicitWaitUtil.waitForElementTobeActionable(driver, objects_locatorType_Toolbar.get("Toolbar - List - Print"), objects_objectLocator_Toolbar.get("Toolbar - List - Print"), Constants_TimeOuts.Element_TimeOut);
			KeyMethods.f_performAction(driver, refID, testcaseName, workFlow, "Toolbar - List - Print", objects_locatorType_Toolbar, objects_objectType_Toolbar, objects_objectLocator_Toolbar, input);
		}
	}
