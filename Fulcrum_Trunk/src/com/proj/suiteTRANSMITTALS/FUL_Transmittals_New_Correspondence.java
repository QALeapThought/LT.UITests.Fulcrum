...
public class FUL_Transmittals_New_Correspondence extends TestSuiteBase{
	...
	public static void TestFUL_Transmittals_New_Correspondence(Hashtable<String,String>data
			) throws Throwable{
		...
		try{
			...
			//************************************** LEVEL 2 *****************************************************************************		
			driver_TRANS=Workflows.Level2_Validate_And_DownloadFiles(siteName,Constants_Workflow.page_myInbox,driver_TRANS,refID,testcaseName, workflow_l2, condition, workflow_end, browserName, transmittalData, data,Transmittals_EntryPage.getRecieverUserCount(data));
