...
public class FUL_Transmittals_ActionRequired_New_ChangeNote extends TestSuiteBase{
	...
	public static void TestFUL_Transmittals_ActionRequired_New_ChangeNote(Hashtable<String,String>data
		...
		try{
			...
			data.put("To", rec);
			transmittalData.put("Tramsmittals-To", rec); 
			transmittalData.put("Tramsmittals-Subject", "Subject-59");
			transmittalData.put("Tramsmittals-TxType", "Change Note");
			transmittalData.put("Action-Level2", data.get("Action-Level2"));*/
			//************************************** LEVEL 2 *****************************************************************************		
			driver_TRANS=Workflows.Level2_Validate_OR_Submit_OR_ApproveOrReject_OR_Forward_OR_ReplyAll_Transmittal(siteName,Constants_Workflow.page_actionRequired,driver_TRANS,refID,testcaseName, workflow_l2, condition, workflow_end, Constants_ConfigProperties.testSiteName, browserName, Constants_ConfigProperties.username_AutoTestAdmin, Constants_ConfigProperties.password_AutoTestAdmin, transmittalData, data,Transmittals_EntryPage.getRecieverUserCount(data));
